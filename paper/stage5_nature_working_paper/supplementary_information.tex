...
\begin{xltabular}{\textwidth}{@{}>{\raggedright\arraybackslash}X *{5}{Y}@{}}
\caption{Mechanism and trust-boundary comparison.}\label{tab:s2} \\
\toprule
...
\midrule
\endfirsthead
\multicolumn{6}{l}{\scriptsize\itshape Continued from previous page} \\
\toprule
\textbf{Mechanism} & \textbf{Primary objective} & \textbf{Distribution relationship} & \textbf{Recipient state} & \textbf{Exact selected-path replay} & \textbf{Tokenization layer} \\
\midrule
\endhead
