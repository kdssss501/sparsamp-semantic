...
Code for probability contracts, replay certificates, checkpointed experiments, external replay packaging, blind-study material generation and statistical analysis is available at `https://github.com/kdssss501/sparsamp-semantic` on the tagged research version `research-v0.35-external-replay-cost-audit`. AUTHOR_INPUT_NEEDED: create an immutable archival release and DOI before submission.
